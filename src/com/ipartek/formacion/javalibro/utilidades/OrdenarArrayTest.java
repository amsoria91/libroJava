...
public class OrdenarArrayTest extends TestCase {
	...
	public void testOrdenacionArray() {
		...
		int[] ordenadorMenorMayor = OrdenarArray.ordenarArray(aDesordando, true);
		
		for (int i = 0; i < ordenadorMenorMayor.length; i++) {
			assertEquals(i, ordenadorMenorMayor[i]);
		}
		
		int[] ordenadorMayorMenor = OrdenarArray.ordenarArray(aDesordando, false);
